...
const LeftLinks = () => {
    return (
        ...
        <ul className='col-lg-6 col-md-12 my-0'>
            ...
            <li className="links-list"><CustomLink className='links' to='/about-us/'>About us</CustomLink></li>
            <li className="links-list"><CustomLink className='links' to='/contact-us/'>Contact us</CustomLink></li>
        </ul>
