...
const Brands = () => {
    return (
        <ul className='brands col-md-4 '>
            ...
            <a target="_blank" href="https://www.capgemini.com/about-us/who-we-are/our-brands/sogeti/"><img className='mt-lg-3 mt-2' src="https://prod.ucwe.capgemini.com/wp-content/themes/capgemini2020/assets/images/Logo_Sogeti.svg" alt="" /></a>
        </ul>
    );
};
