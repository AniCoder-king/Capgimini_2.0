                ...
                <div className='latestnews'>
                    ...
                    <div className="outerlatestnews">
                        <div className="leftlatestnews">
                            <span class="box-tag">Reports</span>
                            <h4>Is the automotive industry on track to meet its sustainability targets?</h4>
                        ...
                        <div className="rightlatestnews">
                            <div class="box">
                                <span class="box-tag">Client news</span>
                                <a class="box-title">
                                    <h4>Consortium led by Airbus and Capgemini selected by the French Ministry of the Interior for the Radio Network of the Future (RRF)</h4>
                                </a>
                            </div>
                            <div class="box">
                                <span class="box-tag">Reports</span>
                                <a class="box-title" >
                                    <h4>Capgemini’s Annual World Energy Markets Observatory, 2022 – A balance must be found between two equally important imperatives: security of affordable energy supply and the fight against climate change</h4>
                                </a>
                            </div>
                            <div class="box">
                                <span class="box-tag">Partners</span>
                                <a class="box-title" >
                                    <h4>Capgemini and Microsoft collaborate to offer cloud-native digital twin solution to help organizations rethink their operations</h4>
                                </a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="row text-center">
                        <div className="col-md-4 mb-5 mb-md-0">
                            <div className="card testimonial-card">
                                ...
                                <div className="avatar mx-auto bg-white">
                                    <img src="https://prod.ucwe.capgemini.com/wp-content/uploads/2020/11/news-getin-1.png?w=250&quality=90" className="rounded-circle img-fluid"/>
                                </div>
                        ...
                        <div className="col-md-4 mb-5 mb-md-0">
                            <div className="card testimonial-card">
                                ...
                                <div className="avatar mx-auto bg-white">
                                    <img src="https://prod.ucwe.capgemini.com/wp-content/uploads/2021/01/MicrosoftTeams-image-25.jpg?w=250&quality=90" className="rounded-circle img-fluid"/>
                                </div>
                                <div className="card-body">
                        ...
                        <div className="col-md-4 mb-0">
                            <div className="card testimonial-card">
                                ...
                                <div className="avatar mx-auto bg-white">
                                    <img src="https://prod.ucwe.capgemini.com/wp-content/uploads/2020/11/news-getin-2.png?w=250&quality=90" className="rounded-circle img-fluid"/>
                                </div>
                                <div className="card-body">
